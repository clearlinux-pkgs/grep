...
Version  : 3.12
Release  : 61
URL      : https://mirrors.kernel.org/gnu/grep/grep-3.12.tar.gz
Source0  : https://mirrors.kernel.org/gnu/grep/grep-3.12.tar.gz
Source1  : https://mirrors.kernel.org/gnu/grep/grep-3.12.tar.gz.sig
...
%setup -q -n grep-3.12
cd %{_builddir}/grep-3.12
%patch -P 1 -p1
pushd ..
cp -a grep-3.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744729397
